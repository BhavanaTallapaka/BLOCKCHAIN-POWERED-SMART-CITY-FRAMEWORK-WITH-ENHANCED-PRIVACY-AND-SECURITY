					...
					<div class="col-lg-10 col-12 mx-auto">
						<div class="timeline-container">
							<ul class="vertical-scrollable-timeline"
								...
								<li>
									<p class="text-white mb-3"  font-size: 25px;"><b>Enter File
										Name You want to search</b></p>
									</h2>


									<form action="Search" method="post" style="float: left; " class="text-white">

										File Name:<input type="text" name="fName" required="required"> <input
								...
								<li>
									<h4 class="text-white mb-3">Bookmark &amp; Keep it for
										yourself</h4>
