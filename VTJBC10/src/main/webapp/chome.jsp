                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav ms-lg-5 me-lg-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link click-scroll" href="Search.jsp">Search</a>
                            </li>
    
                            <li class="nav-item">
                                <a class="nav-link click-scroll" href="KeyView.jsp">Key View</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link click-scroll" href="clientlogin.jsp">Logout</a>
                            </li>
    
                            <li class="nav-item">
                                <a class="nav-link click-scroll" href="client.jsp">Contact</a>
                            </li>
