...
<h3><b style="color: red;">DOWNLOAD FILE</b></h3>
				<%
					
					String fid = request.getParameter("Fid");
					String key=request.getParameter("Key");
				%>
				<form action="Down1" method="post">
					<table style="width: 1200px; padding-left: 50px;">
						
							<tr style="color: blue;"><td>File Id</td>
								<td><input type="text" name="fid" value="<%=fid%>" style="width: 150px;" ></td></tr>
								<tr><td>Key</td><td><input type="password" name="key"   style="width: 150px;" required="required"></td></tr>
								<tr><td><input type="submit" value="Download Data" class="actions"></td></tr>
