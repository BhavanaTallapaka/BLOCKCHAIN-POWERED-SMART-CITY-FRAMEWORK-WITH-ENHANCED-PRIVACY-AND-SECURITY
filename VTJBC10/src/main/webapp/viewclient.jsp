...
String sql="select * from client where sc='pending'";
...
<td><a href="Smartcont.jsp?email=<%=rs.getString(3) %> &&passwors=<%=rs.getString(4) %>">Smart Contract</a>

	</tr>
	
<% }else{%>

<h2>No Client Are Found</h2>
